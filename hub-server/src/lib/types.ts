...
export type PartState = string
export type RunMode = 'single' | 'group' | 'orchestrated'
export type RunStatus = 'queued' | 'running' | 'waiting_approval' | 'waiting_input' | 'completed' | 'failed' | 'cancelled'
...
export type MessageSurface = 'chat' | 'task' | 'system' | 'hidden'
export type RuntimeToolDisplayPolicy = 'timeline' | 'event_log_only'
