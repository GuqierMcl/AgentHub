...
# 运行构建后的可执行文件
./dist/agent-runtime --port 8080 --hostname 0.0.0.0 --cors https://yourdomain.com
```
...
```sh
# Windows PowerShell
$env:PORT=3000; $env:HOSTNAME="0.0.0.0"; $env:CORS="http://localhost:3000,http://example.com"; bun run dev

# Linux/macOS
PORT=3000 HOSTNAME=0.0.0.0 CORS=http://localhost:3000,http://example.com bun run dev
```
