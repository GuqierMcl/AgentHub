...
- 当前 Diff Viewer 是只读的 Phase 1 能力：展示文件列表、hunk、增删行、binary、truncated、dirty baseline 和 runOnlyReliable 提示；不提供 apply、revert、accept/reject hunk 操作。dirty baseline 下必须明确提示“不是精确 run-only patch”。
